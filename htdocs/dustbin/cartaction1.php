		...
		<div id="carttable">
			...
			<?php
				...
				if ($result->num_rows > 0) {
					echo "<table><tr><th>Image</th><th>Item</th><th>Price</th><th>Qty</th><th>Total</th></tr>";
					...
					for ($x = 0; $x < $len-1; $x++){
						...
						echo "<tr><td><img src='img/".$row["pimg"]."' height='100px' width='100px'></td><td>".$row["pname"]."</td><td>".$row["pcost"]."</td><td>".$item[$x][1]."</td><td>".($row["pcost"]*$item[$x][1])."</td></tr>";
					}
					echo "</table>";
				} 
				//else {
