...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="menhalfsleeve.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee1.php">Moksha</a></p><!--Edit Here-->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee1.jpg" height="620px" width="495px">				
			</div>
			<div id="itemdetail">
				<h2><b>Moksha</b></h2>
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 495</p><br><!--Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Attaining moksha in three, two, one! This men's T-shirt has literally got your back! Add this men's printed T-shirt with a back print to your collection and raise the style standards around you. Love it? Get yours now! </p><!--Edit description-->
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">htee1</p><!--Edit extra-->
