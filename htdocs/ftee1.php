...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="fteepg1.php">Full Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="ftee1.php">Bad Trip</a></p><!--Edit Here-->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/ftee1.jpg" height="620px" width="495px">
			</div>
			<div id="itemdetail">
				<h2><b>Bad Trip</b></h2>
				<p id="categ">Men's Full Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 545</p><br><!--Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">This jet black men's t-shirt is the perfect edit to compliment your attitude. Get yours now!</p><!--Edit description-->
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">ftee1</p><!--Edit extra-->
