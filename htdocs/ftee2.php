...
<head>
	...
	<title>
		Classic Maroon/White Sports Trim Full Sleeve T-Shirt
	</title>
...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="fteepg1.php">Full Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="ftee2.php">Classic Maroon/White Sports Trim</a></p><!--Edit Here-->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/ftee2.jpg" height="620px" width="495px">
			</div>
			<div id="itemdetail">
				<h2><b>Classic Maroon/White Sports Trim</b></h2>
				<p id="categ">Men's Full Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 595</p><br><!--Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">An all time favourite. Keep it casual with a pair of denim and cool hair style! Grab yours today!</p><!--Edit description-->
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">ftee2</p><!--Edit extra-->
		...
		<div>
			...
			<div id="suggest"><!-- Edit here with randow products -->
				<div id= "ymal">
					<a href="ftee1.php"><img src="img/ftee1.jpg" height="620px" width="495px">
					<p>Bad Trip</p>
					<p>&#8377 545</p></a>
				</div>
				<div id= "ymal">
