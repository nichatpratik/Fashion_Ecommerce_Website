...
<head>
	...
	<title>
		high Dude (Navy Blue) Full Sleeve T-Shirt
	</title>
...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="fteepg1.php">Full Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="ftee3.php">High Dude (Navy Blue)</a></p><!--Edit Here-->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/ftee3.jpg" height="620px" width="495px">
			</div>
			<div id="itemdetail">
				<h2><b>High Dude (Navy Blue)</b></h2>
				<p id="categ">Men's Full Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 545</p><br><!--Edit Here-->
				...
				<p style="display:none;" id="pcode">ftee3</p><!--Edit extra-->
