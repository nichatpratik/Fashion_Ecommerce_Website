	...
	<body height="100%" width="100%">
		...
		<section>
			<div id="main">
				...
				<div id="bread">
					<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="fteepg1.php">Full Sleeve T-Shirt's</a></p><!--Edit Here-->
				</div>
				<div id ="submain">
					<div id="sidebar">
					...
					<div id="contentbox">
						...
						<div id="suggest">
							...
							<div id= "ymal">
								<a href="ftee6.php"><img src="img/ftee6.jpg" height="620px" width="495px">
								<p>White/Jet Black Sport Trim</p>
								<p>&#8377 545</p></a>
							</div>
						</div>
					</div>
				...
				<div id="bread2"><!--Edit Here-->
					<b><p><i class="fa fa-angle-left" aria-hidden="true"></i> &nbsp  &nbsp <a id="p1" href="ftee.php">1</a> &nbsp  &nbsp <a id="p2" href="ftee.php">2</a> &nbsp  &nbsp <a id="p3" href="ftee.php">3</a> &nbsp  &nbsp <a id="p4" href="ftee.php">4</a> &nbsp  &nbsp <i class="fa fa-angle-right" aria-hidden="true"></i></p><b><!--Edit Here-->
				</div>
			</div>
			<footer id="foot">
				<div id="flogo">
