...
<body height="100%" width="100%">
			...
			<nav id = "nav">
					<div>
						<ul>
							<li id="logolist">
								<a href="home.php">
									<img id = "logo" src="img/logo2.png" vspace = "0" hspace = "0" height="46" width="130">
								</a>
							</li>
						</ul>						
					</div>
	...
	<section id="content">
		...
		<div id="main2">
				...
				<div id="main2end">
					<h2 align="center">GET 1 LICENSED T-SHIRT & 2 FREE GOODIES <br> ONLY &#8377 550 FOR THE FIRST MONTH</h2>
				</div>
		</div>
		<div id="main3">
			<div id="main3head">
		...
		<div id="mainget">
			<div id="btncont">
				<p ><a id="button" type= "button" href="subtee.php">SUBSCRIBE</a></p>
