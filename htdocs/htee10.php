...
<script src="./js/redirectcart.js"></script>
	<title>
		Interstellar Superman (GID) (SL) Half Sleeve T-Shirt
	</title>
...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg2.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee10.php">Interstellar Superman (GID) (SL)</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee10.jpg" height="620px" width="495px"><!-- Edit Here-->
			</div>
			<div id="itemdetail">
				<h2><b>Interstellar Superman (GID) (SL)</b></h2><!-- Edit Here-->
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 495</p><br><!-- Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Thought Superman couldn’t get an upgrade? This Interstellar Superman edit will prove you wrong! Part of the DC Comics line-up, this glow in the dark men’s T-shirt is perfect for any occasion, especially a party! Get yours now! "The Glow in Dark T-shirt needs to be exposed to light (natural/artificial) for about a minute to start glowing"</p>
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">htee10</p><!--Edit extra-->
