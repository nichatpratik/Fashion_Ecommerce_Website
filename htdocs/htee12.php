...
<head>
	...
	<title>
		Flash Logo (Bold Red) (DCL) Sleeve T-Shirt
	</title>
...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg2.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee12.php">Flash Logo (Bold Red) (DCL)</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee12.jpg" height="620px" width="495px"><!-- Edit Here-->
			</div>
			<div id="itemdetail">
				<h2><b>Flash Logo (Bold Red) (DCL)</b></h2><!-- Edit Here-->
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 546</p><br><!-- Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Flash fans, here’s something to be excited about! With Bewakoof teaming up with comic giant DC Comics, things couldn’t get any bigger! Part of the special superhero collection, this Flash men's T-shirt in bold red is the season essential you would want to own. Shop now!</p>
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">htee12</p><!--Edit extra-->
