...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg3.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee14.php">Captain America Halftone (AVL)</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee14.jpg" height="620px" width="495px"><!-- Edit Here-->
			</div>
			<div id="itemdetail">
				<h2><b>Captain America Halftone (AVL)</b></h2><!-- Edit Here-->
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 545</p><br><!-- Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Sport the first Avenger.. This men’s T-shirt is the perfect edit to compliment your attitude. With this navy blue printed half sleeve tee, you are bound to wow everyone with your cool style. Think you need it? Get yours now!</p>
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">htee14</p><!--Edit extra-->
