...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg3.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee15.php">Superman (SL)</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee15.jpg" height="620px" width="495px"><!-- Edit Here-->
			</div>
			<div id="itemdetail">
				<h2><b>Superman (SL)</b></h2><!-- Edit Here-->
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 495</p><br><!-- Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Bewakoof and DC Comics have teamed up to create the most amazing casual wear range inspired by all our favourite superheroes. Grab this bold red 'Superman N 52' men's T-shirt and flash your love for Superman in the trendiest way possible. Pick yours now! </p>
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">htee15</p><!--Edit extra-->
