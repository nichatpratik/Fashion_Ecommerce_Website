...
<script src="./js/redirectcart.js"></script>
	<title>
		Outside The Box Half Sleeve T-Shirt
	</title>
...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg1.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee3.php">Outside The Box</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee3.jpg" height="620px" width="495px"><!-- Edit Here-->
			</div>
			<div id="itemdetail">
				<h2><b>Outside The Box</b></h2><!-- Edit Here-->
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 445</p><br><!-- Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Always think outside the box! Everything is said better with a printed edit. Thank God we have this maroon men's printed half sleeve T-shirt for you! We think this one will fit right into your on-trend wardrobe. You think so too? Well, time to get your hands on one! </p>
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">htee3</p><!--Edit extra-->
		...
		<div>
			...
			<div id="suggest">
				<div id= "ymal">
					<a href="htee6.php"><img src="img/htee6.jpg" height="620px" width="495px"><!-- Edit Here-->
