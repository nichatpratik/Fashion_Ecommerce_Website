...
<script src="./js/redirectcart.js"></script>
	<title>
		Halftone Batman Half Sleeve T-Shirt
	</title>
...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg1.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee5.php">Halftone Batman</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee5.jpg" height="620px" width="495px"><!-- Edit Here-->
			</div>
			<div id="itemdetail">
				<h2><b>Halftone Batman</b></h2><!-- Edit Here-->
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 595</p><br><!-- Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">It's the night! Oh look! There's the Batman. Help Gotham's dark knight spread the message that he's here to protect the people. Our jet black glow in the dark 'Halftone Batman' men's full sleeves tee will do the job for you. Hurry, order now!</p>
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">htee5</p><!--Edit extra-->
