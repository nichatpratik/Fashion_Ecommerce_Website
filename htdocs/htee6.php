...
<script src="./js/redirectcart.js"></script>
	<title>
		Metallic Iron Man Half Sleeve T-Shirt
	</title>
...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg1.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee6.php">Metallic Iron Man</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee6.jpg" height="620px" width="495px"><!-- Edit Here-->
			</div>
			<div id="itemdetail">
				<h2><b>Metallic Iron Man</b></h2><!-- Edit Here-->
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 546</p><br><!-- Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Who's the biggest Iron Man fan? You are? Well, pick this 'Metallic Iron Man' men's printed edit from our store. What's special about it? Oh, just the fact that it glows in the dark! Want it? Get it now! </p>
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">htee6</p><!--Edit extra-->
