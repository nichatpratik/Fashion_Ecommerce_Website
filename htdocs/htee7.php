...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg2.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee7.php">Mountains (Reggae Colours)</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
			...
			<div id="itemdetail">
				...
				<p style="display:none;" id="pcode">htee7</p><!--Edit extra-->
