...
<script src="./js/redirectcart.js"></script>
	<title>
		Ninja Chop Half Sleeve T-Shirt
	</title>
...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg2.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee9.php">Ninja Chop</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee9.jpg" height="620px" width="495px"><!-- Edit Here-->
			</div>
			<div id="itemdetail">
				<h2><b>Ninja Chop</b></h2><!-- Edit Here-->
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 445</p><br><!-- Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Drop it like a ninja chop! Everything is said better with a printed edit. Thank God we have this stone grey men’s printed half sleeve T-shirt for you! We think this one will fit right into your on-trend wardrobe. You think so too? Well, time to get your hands on one!</p>
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">htee9</p><!--Edit extra-->
