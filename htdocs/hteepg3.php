...
<html>
	...
	<body height="100%" width="100%">
		...
		<section>
			<div id="main">
				<div id= "slider">
					<img src="img/hteeslider3.jpg" width="100%">
				</div>
				<div id="bread">
					<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="hteepg3.php">Half Sleeve T-Shirt's</a></p><!--Edit Here-->
				</div>
				<div id ="submain">
					<div id="sidebar">
					...
					<div id="contentbox">
						<div id="suggest">
							<div id= "ymal">
								<a href="htee13.php"><img src="img/htee13.jpg" height="620px" width="495px">
								<p>Acid</p>
								<p>&#8377 445</p></a>
							</div>
							<div id= "ymal">
								<a href="htee14.php"><img src="img/htee14.jpg" height="620px" width="495px">
								<p>Captain America Halftone (AVL)</p>
								<p>&#8377 545</p></a>
							</div>
							<div id= "ymal">
								<a href="htee15.php"><img src="img/htee15.jpg" height="620px" width="495px">
								<p>Superman (SL)</p>
								<p>&#8377 495</p></a>
							</div>
						</div>
						<div id="suggest">
							<div id= "ymal">
								<a href="htee16.php"><img src="img/htee16.jpg" height="620px" width="495px">
								<p>Spiderman (SPL)</p>
								<p>&#8377 545</p></a>
							</div>
							<div id= "ymal">
