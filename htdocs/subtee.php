...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="home.php">RoyalTees</a> &nbsp / &nbsp <a href="subtee.php">Royal Box</a> &nbsp / &nbsp <a href="subtee.php">Tshirt Subcription</a></p><!--Edit Here-->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/stee.jpg" height="620px" width="495px">
			</div>
			<div id="itemdetail">
				<h2><b>Royal Box</b></h2>
				<p id="categ">RoyalTees Subscription</p>
				<p id="prices">&#8377 </p><p id="price"> 550</p><br><!--Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Each month, Royal Box subscribers receive an epic package that includes a premium licensed shirt and two super awesome free gears in the genre of their choosing. We are giving you a little bit of a surprise, but just the right amount.</p><!--Edit description-->
				<hr>
				<script src="./js/cart.js"></script><!--Edit extra-->
				<p style="display:none;" id="pcode">stee</p><!--Edit extra-->
		...
		<div>
			...
			<div id="suggest"><!-- Edit here with randow products -->
				<div id= "ymal">
					<a href="ftee2.php"><img src="img/ftee2.jpg" height="620px" width="495px">
					<p>Classic Maroon/White Sports Trim</p>
					<p>&#8377 595</p></a>
				</div>
				<div id= "ymal">
					<a href="ftee3.php"><img src="img/ftee3.jpg" height="620px" width="495px">
					<p>High Dude</p>
					<p>&#8377 545</p></a>
				</div>
				<div id= "ymal">
					<a href="ftee4.php"><img src="img/ftee4.jpg" height="620px" width="495px">
					<p>War Machine Halftone (AVL)</p>
					<p>&#8377 495</p></a>
				</div>
				<div id= "ymal">
					<a href="ftee5.php"><img src="img/ftee5.jpg" height="620px" width="495px">
					<p>Moksha</p>
					<p>&#8377 555</p></a>
				</div>
